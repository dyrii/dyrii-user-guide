...
This is the root view of the app from where you could get to all the other views. For example, Timeline, Today, Perspectives can be navigated to from this view. The Settings option is also located on this view.  
